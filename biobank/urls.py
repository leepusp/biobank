...
from core.views.internal.chemicals.views import chemicals_list_view, chemical_create_view, chemicals_dashboard_view, chemical_detail_view, chemical_edit_view, chemical_delete_view
