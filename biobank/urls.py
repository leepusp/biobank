...
urlpatterns = [
    ...
    path("samples/map/", samples_origin_map_view, name="samples_origin_map"),
    ...
    path('internal/api/search-molecular-sequences/', notebook_views.search_molecular_sequences_api, name='search_molecular_sequences_api'),
