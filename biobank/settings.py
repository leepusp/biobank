...
B3_LIMS_URL_PREFIX = "/b3lims"
FORCE_SCRIPT_NAME = B3_LIMS_URL_PREFIX
...
STATIC_URL = f"{B3_LIMS_URL_PREFIX}/static/"
...
# =========================
MEDIA_URL = f"{B3_LIMS_URL_PREFIX}/data/"
...
# AUTENTICAÇÃO
# =========================
LOGIN_URL = f"{B3_LIMS_URL_PREFIX}/login/"
LOGOUT_URL = f"{B3_LIMS_URL_PREFIX}/logout/"
LOGIN_REDIRECT_URL = f"{B3_LIMS_URL_PREFIX}/workspace/"
